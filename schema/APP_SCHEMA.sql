...
CREATE SCHEMA IF NOT EXISTS "SNOW_SCHEMA"."SNOW_SCHEMA"
WITH MANAGED ACCESS;

CREATE OR REPLACE FILE FORMAT "SNOW_SCHEMA"."SNOW_SCHEMA"."DOCX_FORMAT" 
TYPE = 'CUSTOM';

COMMENT ON FILE FORMAT "SNOW_SCHEMA"."SNOW_SCHEMA"."DOCX_FORMAT" IS '';

CREATE OR REPLACE FILE FORMAT "SNOW_SCHEMA"."SNOW_SCHEMA"."JSON" 
TYPE = 'JSON'
TIMESTAMP_FORMAT = 'YYYY-MM-DD HH24-MI-SS';

COMMENT ON FILE FORMAT "SNOW_SCHEMA"."SNOW_SCHEMA"."JSON" IS '';

CREATE STAGE IF NOT EXISTS "SNOW_SCHEMA"."SNOW_SCHEMA"."APP_STAGE"

DIRECTORY = ( ENABLE = TRUE );

CREATE STAGE IF NOT EXISTS "SNOW_SCHEMA"."SNOW_SCHEMA"."SMA_EXECUTIONS"

DIRECTORY = ( ENABLE = TRUE );

CREATE STAGE IF NOT EXISTS "SNOW_SCHEMA"."SNOW_SCHEMA"."SMA_MAPPINGS"

DIRECTORY = ( ENABLE = TRUE );

CREATE SEQUENCE IF NOT EXISTS "SNOW_SCHEMA"."SNOW_SCHEMA"."APP_LOG_SEQUENCE"
START = 1
INCREMENT = 1;

CREATE SEQUENCE IF NOT EXISTS "SNOW_SCHEMA"."SNOW_SCHEMA"."AUTOINCREMENT_SEQUENCE"
START = 1
INCREMENT = 1;

CREATE OR REPLACE FUNCTION "SNOW_SCHEMA"."SNOW_SCHEMA"."GET_VERSION" (
...
COMMENT ON FUNCTION "SNOW_SCHEMA"."SNOW_SCHEMA"."GET_VERSION"(VARCHAR) IS '';

CREATE OR REPLACE PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."GET_IMPORTS_MAPPINGS" (
)
RETURNS TABLE (
...
HANDLER = 'main'
COMMENT = '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":6,"patch":8}}'
...
COMMENT ON PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."GET_IMPORTS_MAPPINGS"() IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":6,"patch":8}} ';

CREATE OR REPLACE PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."INSERT_MAPPINGS_EWI_CATALOG" (
...
COMMENT ON PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."INSERT_MAPPINGS_EWI_CATALOG"(VARCHAR) IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":6,"patch":8}} ';

CREATE OR REPLACE PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."INSERT_MAPPINGS_LIBRARY" (
      "TABLE_NAME" VARCHAR(16777216)
)
RETURNS VARCHAR(16777216)
LANGUAGE SQL
...
COMMENT ON PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."INSERT_MAPPINGS_LIBRARY"(VARCHAR) IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":6,"patch":8}} ';

CREATE OR REPLACE PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."INSERT_MAPPINGS_PANDAS" (
      "TABLE_NAME" VARCHAR(16777216)
)
RETURNS VARCHAR(16777216)
LANGUAGE SQL
...
COMMENT ON PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."INSERT_MAPPINGS_PANDAS"(VARCHAR) IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":6,"patch":8}} ';

CREATE OR REPLACE PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."MERGE_SQL_EMBEDDED_USAGES_INVENTORY" (
      "TABLE_NAME" VARCHAR(16777216)
)
RETURNS VARCHAR(16777216)
LANGUAGE SQL
...
COMMENT ON PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."MERGE_SQL_EMBEDDED_USAGES_INVENTORY"(VARCHAR) IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":6,"patch":8}} ';

CREATE OR REPLACE PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."MERGE_SQL_FUNCTIONS_INVENTORY" (
      "TABLE_NAME" VARCHAR(16777216)
)
RETURNS VARCHAR(16777216)
LANGUAGE SQL
...
COMMENT ON PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."MERGE_SQL_FUNCTIONS_INVENTORY"(VARCHAR) IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":6,"patch":8}} ';

CREATE OR REPLACE PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."MERGE_THIRD_PARTY_USAGES_INVENTORY" (
      "TABLE_NAME" VARCHAR(16777216)
)
RETURNS VARCHAR(16777216)
LANGUAGE SQL
...
COMMENT ON PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."MERGE_THIRD_PARTY_USAGES_INVENTORY"(VARCHAR) IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":6,"patch":8}} ';

CREATE OR REPLACE PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."PRE_CALC_DEPENDENCY_ANALYSIS" (
)
RETURNS VARCHAR(16777216)
LANGUAGE python
RUNTIME_VERSION = '3.9'
...
COMMENT ON PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."PRE_CALC_DEPENDENCY_ANALYSIS"() IS '';

CREATE OR REPLACE PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."INSERT_COMPUTED_DEPENDENCIES" (
)
RETURNS VARCHAR(16777216)
LANGUAGE SQL
COMMENT = '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":6,"patch":8}}'
...
COMMENT ON PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."INSERT_COMPUTED_DEPENDENCIES"() IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":6,"patch":8}} ';

CREATE OR REPLACE PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."INSERT_JAVA_BUILTINS" (
)
RETURNS VARCHAR(16777216)
LANGUAGE SQL
COMMENT = '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":6,"patch":8}}'
...
COMMENT ON PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."INSERT_JAVA_BUILTINS"() IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":6,"patch":8}} ';

CREATE OR REPLACE PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."INSERT_APP_LOG" (
...
COMMENT ON PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."INSERT_APP_LOG"(VARCHAR,VARCHAR,VARCHAR,VARCHAR) IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":6,"patch":8}} ';

CREATE OR REPLACE PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."MERGE_ARTIFACTS_DEPENDENCY_INVENTORY" (
      "TABLE_NAME" VARCHAR(16777216)
)
RETURNS VARCHAR(16777216)
LANGUAGE SQL
...
DECLARE
   BACKSLASH_TOKEN := ''\\\\'';
   SLASH_TOKEN := ''/'';
   ARTIFACTS_DEPENDENCY_INVENTORY_NAME := ''ArtifactsDependencyInventory%.json'';

BEGIN

    INSERT INTO ARTIFACTS_DEPENDENCY_INVENTORY(
    EXECUTION_ID,
    FILE,
    NAME,
    TYPE,
    ...
    SELECT
    EXECUTION_ID,
    REPLACE(INVENTORY_CONTENT:FILE, :BACKSLASH_TOKEN, :SLASH_TOKEN),
    ...
    FROM (
      ...
      FROM (
        ...
        FROM IDENTIFIER(:TABLE_NAME)
        WHERE FILE_NAME ILIKE :ARTIFACTS_DEPENDENCY_INVENTORY_NAME
      ), TABLE(FLATTEN(INVENTORY_CONTENT)) INVENTORY_CONTENT_JSON
    );
...
COMMENT ON PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."MERGE_ARTIFACTS_DEPENDENCY_INVENTORY"(VARCHAR) IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":6,"patch":8}} ';

CREATE OR REPLACE PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."MERGE_DATA_TO_IAA_TABLES" (
      "TABLE_NAME" VARCHAR(16777216)
)
RETURNS VARCHAR(16777216)
LANGUAGE SQL
...
COMMENT ON PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."MERGE_DATA_TO_IAA_TABLES"(VARCHAR) IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":6,"patch":8}} ';

CREATE OR REPLACE PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."MERGE_EXECUTION_INFO" (
      "TABLE_NAME" VARCHAR(16777216)
)
RETURNS VARCHAR(16777216)
LANGUAGE SQL
...
COMMENT ON PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."MERGE_EXECUTION_INFO"(VARCHAR) IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":6,"patch":8}} ';

CREATE OR REPLACE PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."MERGE_IMPORT_USAGES_INVENTORY" (
      "TABLE_NAME" VARCHAR(16777216)
)
RETURNS VARCHAR(16777216)
LANGUAGE SQL
...
COMMENT ON PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."MERGE_IMPORT_USAGES_INVENTORY"(VARCHAR) IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":6,"patch":8}} ';

CREATE OR REPLACE PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."MERGE_INPUT_FILE_INVENTORY" (
      "TABLE_NAME" VARCHAR(16777216)
)
RETURNS VARCHAR(16777216)
LANGUAGE SQL
...
COMMENT ON PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."MERGE_INPUT_FILE_INVENTORY"(VARCHAR) IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":6,"patch":8}} ';

CREATE OR REPLACE PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."MERGE_IO_FILES_INVENTORY" (
      "TABLE_NAME" VARCHAR(16777216)
)
RETURNS VARCHAR(16777216)
LANGUAGE SQL
...
COMMENT ON PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."MERGE_IO_FILES_INVENTORY"(VARCHAR) IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":6,"patch":8}} ';

CREATE OR REPLACE PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."MERGE_ISSUES_INVENTORY" (
      "TABLE_NAME" VARCHAR(16777216)
)
RETURNS VARCHAR(16777216)
LANGUAGE SQL
...
COMMENT ON PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."MERGE_ISSUES_INVENTORY"(VARCHAR) IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":6,"patch":8}} ';

CREATE OR REPLACE PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."INSERT_MAPPINGS_PYSPARK" (
      "TABLE_NAME" VARCHAR(16777216)
)
RETURNS VARCHAR(16777216)
LANGUAGE SQL
...
COMMENT ON PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."INSERT_MAPPINGS_PYSPARK"(VARCHAR) IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":6,"patch":8}} ';

CREATE OR REPLACE PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."INSERT_MAPPINGS_SPARK" (
      "TABLE_NAME" VARCHAR(16777216)
)
RETURNS VARCHAR(16777216)
LANGUAGE SQL
...
COMMENT ON PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."INSERT_MAPPINGS_SPARK"(VARCHAR) IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":6,"patch":8}} ';

CREATE OR REPLACE PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."INSERT_MAPPINGS_SQL_ELEMENTS" (
      "TABLE_NAME" VARCHAR(16777216)
)
RETURNS VARCHAR(16777216)
LANGUAGE SQL
...
COMMENT ON PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."INSERT_MAPPINGS_SQL_ELEMENTS"(VARCHAR) IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":6,"patch":8}} ';

CREATE OR REPLACE PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."INSERT_MAPPINGS_SQL_FUNCTIONS" (
      "TABLE_NAME" VARCHAR(16777216)
)
RETURNS VARCHAR(16777216)
LANGUAGE SQL
...
COMMENT ON PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."INSERT_MAPPINGS_SQL_FUNCTIONS"(VARCHAR) IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":6,"patch":8}} ';

CREATE OR REPLACE PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."INSERT_PIPE_DATA_TO_IAA_TABLES" (
)
RETURNS VARCHAR(16777216)
LANGUAGE SQL
COMMENT = '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":6,"patch":8}}'
...
COMMENT ON PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."INSERT_PIPE_DATA_TO_IAA_TABLES"() IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":6,"patch":8}} ';

CREATE OR REPLACE PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."INSERT_THIRD_PARTY_CATEGORIES" (
)
RETURNS VARCHAR(16777216)
LANGUAGE SQL
COMMENT = '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":6,"patch":8}}'
...
COMMENT ON PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."INSERT_THIRD_PARTY_CATEGORIES"() IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":6,"patch":8}} ';

CREATE OR REPLACE PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."MERGE_JOINS_INVENTORY" (
      "TABLE_NAME" VARCHAR(16777216)
)
RETURNS VARCHAR(16777216)
LANGUAGE SQL
...
COMMENT ON PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."MERGE_JOINS_INVENTORY"(VARCHAR) IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":6,"patch":8}} ';

CREATE OR REPLACE PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."MERGE_NOTEBOOK_CELLS_INVENTORY" (
      "TABLE_NAME" VARCHAR(16777216)
)
RETURNS VARCHAR(16777216)
LANGUAGE SQL
...
COMMENT ON PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."MERGE_NOTEBOOK_CELLS_INVENTORY"(VARCHAR) IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":6,"patch":8}} ';

CREATE OR REPLACE PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."MERGE_NOTEBOOK_SIZE_INVENTORY" (
      "TABLE_NAME" VARCHAR(16777216)
)
RETURNS VARCHAR(16777216)
LANGUAGE SQL
...
COMMENT ON PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."MERGE_NOTEBOOK_SIZE_INVENTORY"(VARCHAR) IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":6,"patch":8}} ';

CREATE OR REPLACE PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."MERGE_PACKAGE_INVENTORY" (
      "TABLE_NAME" VARCHAR(16777216)
)
RETURNS VARCHAR(16777216)
LANGUAGE SQL
...
COMMENT ON PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."MERGE_PACKAGE_INVENTORY"(VARCHAR) IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":6,"patch":8}} ';

CREATE OR REPLACE PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."MERGE_PACKAGE_VERSIONS_INVENTORY" (
      "TABLE_NAME" VARCHAR(16777216)
)
RETURNS VARCHAR(16777216)
LANGUAGE SQL
...
COMMENT ON PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."MERGE_PACKAGE_VERSIONS_INVENTORY"(VARCHAR) IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":6,"patch":8}} ';

CREATE OR REPLACE PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."MERGE_PANDAS_USAGES_INVENTORY" (
      "TABLE_NAME" VARCHAR(16777216)
)
RETURNS VARCHAR(16777216)
LANGUAGE SQL
...
COMMENT ON PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."MERGE_PANDAS_USAGES_INVENTORY"(VARCHAR) IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":6,"patch":8}} ';

CREATE OR REPLACE PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."MERGE_SPARK_USAGES_INVENTORY" (
      "TABLE_NAME" VARCHAR(16777216)
)
RETURNS VARCHAR(16777216)
LANGUAGE SQL
...
COMMENT ON PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."MERGE_SPARK_USAGES_INVENTORY"(VARCHAR) IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":6,"patch":8}} ';

CREATE OR REPLACE PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."MERGE_SQL_ELEMENTS_INVENTORY" (
      "TABLE_NAME" VARCHAR(16777216)
)
RETURNS VARCHAR(16777216)
LANGUAGE SQL
...
COMMENT ON PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."MERGE_SQL_ELEMENTS_INVENTORY"(VARCHAR) IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":6,"patch":8}} ';

CREATE OR REPLACE PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."REFRESH_MANUAL_EXECUTION" (
)
RETURNS VARCHAR(16777216)
LANGUAGE SQL
COMMENT = '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":6,"patch":8}}'
...
COMMENT ON PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."REFRESH_MANUAL_EXECUTION"() IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":6,"patch":8}} ';

CREATE OR REPLACE PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."REFRESH_MANUAL_MAPPINGS" (
)
RETURNS VARCHAR(16777216)
LANGUAGE SQL
COMMENT = '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":6,"patch":8}}'
...
COMMENT ON PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."REFRESH_MANUAL_MAPPINGS"() IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":6,"patch":8}} ';

CREATE OR REPLACE PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."REFRESH_MAPPINGS_CORE" (
)
RETURNS VARCHAR(16777216)
LANGUAGE SQL
COMMENT = '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":6,"patch":8}}'
...
COMMENT ON PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."REFRESH_MAPPINGS_CORE"() IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":6,"patch":8}} ';

CREATE OR REPLACE PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."START_IAA_MECHANISM" (
)
RETURNS VARCHAR(16777216)
LANGUAGE SQL
AS 'BEGIN
...
COMMENT ON PROCEDURE "SNOW_SCHEMA"."SNOW_SCHEMA"."START_IAA_MECHANISM"() IS '';

CREATE OR REPLACE TABLE "SNOW_SCHEMA"."SNOW_SCHEMA"."ALL_MAPPINGS_CORE_RAW"
(
...
CREATE OR REPLACE TABLE "SNOW_SCHEMA"."SNOW_SCHEMA"."APP_LOG"
(
      "ID" NUMBER(10,0) DEFAULT SNOW_SCHEMA.SNOW_SCHEMA.APP_LOG_SEQUENCE.NEXTVAL NOT NULL
    , "APPLICATION" VARCHAR(16777216)
    , "MESSAGE" VARCHAR(16777216)
    , "CUSTOMER_EMAIL" VARCHAR(16777216)
    , "EXECUTION_ID" VARCHAR(16777216)
...
CREATE OR REPLACE TABLE "SNOW_SCHEMA"."SNOW_SCHEMA"."ARTIFACTS_DEPENDENCY_INVENTORY"
(
      "EXECUTION_ID" VARCHAR(16777216)
...
CREATE OR REPLACE TABLE "SNOW_SCHEMA"."SNOW_SCHEMA"."ASSESSMENTS_FILES_RAW"
(
      "EXECUTION_ID" VARCHAR(16777216)
    , "EXTRACT_DATE" TIMESTAMP_NTZ(9)
    , "FILE_NAME" VARCHAR(16777216)
...
CREATE OR REPLACE TABLE "SNOW_SCHEMA"."SNOW_SCHEMA"."COMPUTED_DEPENDENCIES"
(
...
CREATE OR REPLACE TABLE "SNOW_SCHEMA"."SNOW_SCHEMA"."EXECUTION_INFO"
(
      "EXECUTION_ID" VARCHAR(16777216)
...
CREATE OR REPLACE TABLE "SNOW_SCHEMA"."SNOW_SCHEMA"."IMPORT_USAGES_INVENTORY"
(
      "EXECUTION_ID" VARCHAR(16777216)
...
CREATE OR REPLACE TABLE "SNOW_SCHEMA"."SNOW_SCHEMA"."INPUT_FILES_INVENTORY"
(
      "EXECUTION_ID" VARCHAR(16777216)
    , "ELEMENT" VARCHAR(16777216)
    , "PROJECT_ID" VARCHAR(16777216)
...
CREATE OR REPLACE TABLE "SNOW_SCHEMA"."SNOW_SCHEMA"."IO_FILES_INVENTORY"
(
      "EXECUTION_ID" VARCHAR(16777216)
    , "ELEMENT" VARCHAR(16777216)
    , "PROJECT_ID" VARCHAR(16777216)
...
CREATE OR REPLACE TABLE "SNOW_SCHEMA"."SNOW_SCHEMA"."ISSUES_INVENTORY"
(
      "EXECUTION_ID" VARCHAR(16777216)
...
CREATE OR REPLACE TABLE "SNOW_SCHEMA"."SNOW_SCHEMA"."JAVA_BUILTINS"
(
      "NAME" VARCHAR(16777216)
)
COMMENT = '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":6,"patch":8}}';

CREATE OR REPLACE TABLE "SNOW_SCHEMA"."SNOW_SCHEMA"."JOINS_INVENTORY"
(
      "EXECUTION_ID" VARCHAR(16777216)
    , "ELEMENT" VARCHAR(16777216)
    , "PROJECT_ID" VARCHAR(16777216)
...
CREATE OR REPLACE TABLE "SNOW_SCHEMA"."SNOW_SCHEMA"."MANUAL_UPLOADED_ZIPS"
(
      "EXECUTION_ID" VARCHAR(16777216)
...
CREATE OR REPLACE TABLE "SNOW_SCHEMA"."SNOW_SCHEMA"."MAPPINGS_CORE_EWI_CATALOG"
(
      "VERSION" VARCHAR(16777216)
...
CREATE OR REPLACE TABLE "SNOW_SCHEMA"."SNOW_SCHEMA"."MAPPINGS_CORE_LIBRARIES"
(
      "VERSION" VARCHAR(16777216)
...
CREATE OR REPLACE TABLE "SNOW_SCHEMA"."SNOW_SCHEMA"."MAPPINGS_CORE_PANDAS"
(
      "VERSION" VARCHAR(16777216)
    , "CATEGORY" VARCHAR(16777216)
...
CREATE OR REPLACE TABLE "SNOW_SCHEMA"."SNOW_SCHEMA"."MAPPINGS_CORE_PYSPARK"
(
      "VERSION" VARCHAR(16777216)
    , "CATEGORY" VARCHAR(16777216)
    , "SPARK_FULLY_QUALIFIED_NAME" VARCHAR(16777216)
...
CREATE OR REPLACE TABLE "SNOW_SCHEMA"."SNOW_SCHEMA"."MAPPINGS_CORE_SPARK"
(
      "VERSION" VARCHAR(16777216)
    , "CATEGORY" VARCHAR(16777216)
    , "SPARK_FULLY_QUALIFIED_NAME" VARCHAR(16777216)
...
CREATE OR REPLACE TABLE "SNOW_SCHEMA"."SNOW_SCHEMA"."MAPPINGS_CORE_SQL_ELEMENTS"
(
      "VERSION" VARCHAR(16777216)
    , "ELEMENT" VARCHAR(16777216)
...
CREATE OR REPLACE TABLE "SNOW_SCHEMA"."SNOW_SCHEMA"."MAPPINGS_CORE_SQL_FUNCTIONS"
(
      "VERSION" VARCHAR(16777216)
    , "ELEMENT" VARCHAR(16777216)
    , "FLAVOR" VARCHAR(16777216)
...
CREATE OR REPLACE TABLE "SNOW_SCHEMA"."SNOW_SCHEMA"."NOTEBOOK_CELLS_INVENTORY"
(
      "EXECUTION_ID" VARCHAR(16777216)
    , "ELEMENT" VARCHAR(16777216)
    , "PROJECT_ID" VARCHAR(16777216)
...
CREATE OR REPLACE TABLE "SNOW_SCHEMA"."SNOW_SCHEMA"."NOTEBOOK_SIZE_INVENTORY"
(
      "EXECUTION_ID" VARCHAR(16777216)
    , "ELEMENT" VARCHAR(16777216)
    , "PROJECT_ID" VARCHAR(16777216)
...
CREATE OR REPLACE TABLE "SNOW_SCHEMA"."SNOW_SCHEMA"."PACKAGES_INVENTORY"
(
      "EXECUTION_ID" VARCHAR(16777216)
    , "ELEMENT" VARCHAR(16777216)
    , "PROJECT_ID" VARCHAR(16777216)
...
CREATE OR REPLACE TABLE "SNOW_SCHEMA"."SNOW_SCHEMA"."PACKAGE_VERSIONS_INVENTORY"
(
      "EXECUTION_ID" VARCHAR(16777216)
    , "ELEMENT" VARCHAR(16777216)
    , "PROJECT_ID" VARCHAR(16777216)
...
CREATE OR REPLACE TABLE "SNOW_SCHEMA"."SNOW_SCHEMA"."PANDAS_USAGES_INVENTORY"
(
      "EXECUTION_ID" VARCHAR(16777216)
    , "ELEMENT" VARCHAR(16777216)
    , "PROJECT_ID" VARCHAR(16777216)
...
CREATE OR REPLACE TABLE "SNOW_SCHEMA"."SNOW_SCHEMA"."PENDING_EXECUTION_LIST"
(
      "EXECUTION_ID" VARCHAR(16777216)
    , "MESSAGE" VARCHAR(16777216)
...
CREATE OR REPLACE TABLE "SNOW_SCHEMA"."SNOW_SCHEMA"."REPORT_URL"
(
      "EXECUTION_ID" VARCHAR(16777216)
    , "FILE_NAME" VARCHAR(16777216)
...
CREATE OR REPLACE TABLE "SNOW_SCHEMA"."SNOW_SCHEMA"."SPARK_USAGES_INVENTORY"
(
      "EXECUTION_ID" VARCHAR(16777216)
    , "ELEMENT" VARCHAR(16777216)
    , "PROJECT_ID" VARCHAR(16777216)
...
CREATE OR REPLACE TABLE "SNOW_SCHEMA"."SNOW_SCHEMA"."SQL_ELEMENTS_INVENTORY"
(
      "EXECUTION_ID" VARCHAR(16777216)
    , "ELEMENT" VARCHAR(16777216)
    , "PROJECT_ID" VARCHAR(16777216)
...
CREATE OR REPLACE TABLE "SNOW_SCHEMA"."SNOW_SCHEMA"."SQL_EMBEDDED_USAGES_INVENTORY"
(
      "EXECUTION_ID" VARCHAR(16777216)
    , "ELEMENT" VARCHAR(16777216)
    , "PROJECT_ID" VARCHAR(16777216)
...
CREATE OR REPLACE TABLE "SNOW_SCHEMA"."SNOW_SCHEMA"."SQL_FUNCTIONS_INVENTORY"
(
      "EXECUTION_ID" VARCHAR(16777216)
    , "ELEMENT" VARCHAR(16777216)
    , "PROJECT_ID" VARCHAR(16777216)
...
CREATE OR REPLACE TABLE "SNOW_SCHEMA"."SNOW_SCHEMA"."TELEMETRY_EVENTS"
(
      "ID" NUMBER(38,0) DEFAULT SNOW_SCHEMA.SNOW_SCHEMA.AUTOINCREMENT_SEQUENCE.NEXTVAL
    , "TIMESTAMP" TIMESTAMP_NTZ(9)
    , "NAME" VARCHAR(16777216)
...
CREATE OR REPLACE TABLE "SNOW_SCHEMA"."SNOW_SCHEMA"."TELEMETRY_EVENTS_ATTRIBUTES"
(
      "EVENTID" NUMBER(38,0)
    , "TIMESTAMP" TIMESTAMP_NTZ(9)
    , "NAME" VARCHAR(16777216)
...
CREATE OR REPLACE TABLE "SNOW_SCHEMA"."SNOW_SCHEMA"."THIRD_PARTY_CATEGORIES"
(
      "CATEGORY" VARCHAR(16777216)
...
CREATE OR REPLACE TABLE "SNOW_SCHEMA"."SNOW_SCHEMA"."THIRD_PARTY_USAGES_INVENTORY"
(
      "EXECUTION_ID" VARCHAR(16777216)
    , "ELEMENT" VARCHAR(16777216)
    , "PROJECT_ID" VARCHAR(16777216)
...
ALTER TABLE "SNOW_SCHEMA"."SNOW_SCHEMA"."APP_LOG" ADD PRIMARY KEY ("ID");

CREATE OR REPLACE STREAM "SNOW_SCHEMA"."SNOW_SCHEMA"."ALL_MAPPINGS_CORE_STREAM"
ON TABLE "SNOW_SCHEMA"."SNOW_SCHEMA"."ALL_MAPPINGS_CORE_RAW";

CREATE OR REPLACE STREAM "SNOW_SCHEMA"."SNOW_SCHEMA"."ASSESSMENTS_FILES_STREAM"
ON TABLE "SNOW_SCHEMA"."SNOW_SCHEMA"."ASSESSMENTS_FILES_RAW";

CREATE OR REPLACE STREAM "SNOW_SCHEMA"."SNOW_SCHEMA"."EXECUTION_INFO_STREAM"
ON TABLE "SNOW_SCHEMA"."SNOW_SCHEMA"."EXECUTION_INFO";

CREATE OR REPLACE TASK "SNOW_SCHEMA"."SNOW_SCHEMA"."INSERT_COMPUTED_DEPENDENCIES"
...
COMMENT ON TASK "SNOW_SCHEMA"."SNOW_SCHEMA"."INSERT_COMPUTED_DEPENDENCIES" IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":6,"patch":8}} ';

CREATE OR REPLACE TASK "SNOW_SCHEMA"."SNOW_SCHEMA"."REFRESH_MAPPINGS_CORE_TASK"
WAREHOUSE = "SNOW_WAREHOUSE"
COMMENT = '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":6,"patch":8}}'
...
COMMENT ON TASK "SNOW_SCHEMA"."SNOW_SCHEMA"."REFRESH_MAPPINGS_CORE_TASK" IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":6,"patch":8}} ';

CREATE OR REPLACE TASK "SNOW_SCHEMA"."SNOW_SCHEMA"."UPDATE_IAA_TABLES_TASK"
WAREHOUSE = "SNOW_WAREHOUSE"
COMMENT = '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":6,"patch":8}}'
...
COMMENT ON TASK "SNOW_SCHEMA"."SNOW_SCHEMA"."UPDATE_IAA_TABLES_TASK" IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":6,"patch":8}} ';
