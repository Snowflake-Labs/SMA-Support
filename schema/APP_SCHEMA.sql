...
HANDLER = 'main'
COMMENT = '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":1,"patch":112}}'
...
COMMENT ON PROCEDURE "SNOW_DB"."SNOW_SCHEMA"."GET_IMPORTS_MAPPINGS"() IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":1,"patch":112}} ';
...
COMMENT ON PROCEDURE "SNOW_DB"."SNOW_SCHEMA"."INSERT_JAVA_BUILTINS"() IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":1,"patch":112}} ';
...
COMMENT ON PROCEDURE "SNOW_DB"."SNOW_SCHEMA"."INSERT_MAPPINGS_EWI_CATALOG"(VARCHAR) IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":1,"patch":112}} ';
...
COMMENT ON PROCEDURE "SNOW_DB"."SNOW_SCHEMA"."INSERT_MAPPINGS_LIBRARY"(VARCHAR) IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":1,"patch":112}} ';
...
COMMENT ON PROCEDURE "SNOW_DB"."SNOW_SCHEMA"."INSERT_MAPPINGS_PANDAS"(VARCHAR) IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":1,"patch":112}} ';
...
COMMENT ON PROCEDURE "SNOW_DB"."SNOW_SCHEMA"."INSERT_MAPPINGS_PYSPARK"(VARCHAR) IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":1,"patch":112}} ';
...
COMMENT ON PROCEDURE "SNOW_DB"."SNOW_SCHEMA"."INSERT_MAPPINGS_SPARK"(VARCHAR) IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":1,"patch":112}} ';
...
COMMENT ON PROCEDURE "SNOW_DB"."SNOW_SCHEMA"."INSERT_MAPPINGS_SQL_ELEMENTS"(VARCHAR) IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":1,"patch":112}} ';
...
COMMENT ON PROCEDURE "SNOW_DB"."SNOW_SCHEMA"."INSERT_MAPPINGS_SQL_FUNCTIONS"(VARCHAR) IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":1,"patch":112}} -WBmAAc5';
...
COMMENT ON PROCEDURE "SNOW_DB"."SNOW_SCHEMA"."INSERT_PIPE_DATA_TO_IAA_TABLES"() IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":1,"patch":112}} ';
...
COMMENT ON PROCEDURE "SNOW_DB"."SNOW_SCHEMA"."INSERT_THIRD_PARTY_CATEGORIES"() IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":1,"patch":112}} ';
...
COMMENT ON PROCEDURE "SNOW_DB"."SNOW_SCHEMA"."MERGE_DATA_TO_IAA_TABLES"(VARCHAR) IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":1,"patch":112}} ';
...
BEGIN
    ...
    FROM IDENTIFIER(:TABLE_NAME)
    WHERE FILE_NAME = :EXECUTION_INFO_INVENTORY_NAME
...
COMMENT ON PROCEDURE "SNOW_DB"."SNOW_SCHEMA"."MERGE_EXECUTION_INFO"(VARCHAR) IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":1,"patch":112}} -ogtShb';
...
BEGIN
    ...
    FROM IDENTIFIER(:TABLE_NAME)
    WHERE FILE_NAME = :IMPORT_USAGES_INVENTORY_NAME
    ), TABLE(FLATTEN(INVENTORY_CONTENT)) INVENTORY_CONTENT_JSON
    );
...
COMMENT ON PROCEDURE "SNOW_DB"."SNOW_SCHEMA"."MERGE_IMPORT_USAGES_INVENTORY"(VARCHAR) IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":1,"patch":112}} ';
...
BEGIN
   ...
   INSERT INTO INPUT_FILES_INVENTORY(
    ...
    SELECT EXECUTION_ID, INVENTORY_CONTENT
    FROM IDENTIFIER(:TABLE_NAME)
    WHERE FILE_NAME = :INPUT_FILES_INVENTORY_NAME
    ), TABLE(FLATTEN(INVENTORY_CONTENT)) INVENTORY_CONTENT_JSON
    );
...
COMMENT ON PROCEDURE "SNOW_DB"."SNOW_SCHEMA"."MERGE_INPUT_FILE_INVENTORY"(VARCHAR) IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":1,"patch":112}} ';
...
BEGIN
    ...
    SELECT EXECUTION_ID, INVENTORY_CONTENT
    FROM IDENTIFIER(:TABLE_NAME)
    WHERE FILE_NAME = :IO_FILES_INVENTORY_NAME
    ), TABLE(FLATTEN(INVENTORY_CONTENT)) INVENTORY_CONTENT_JSON
    );
...
COMMENT ON PROCEDURE "SNOW_DB"."SNOW_SCHEMA"."MERGE_IO_FILES_INVENTORY"(VARCHAR) IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":1,"patch":112}} -6ZvG1wkxV_n';
...
BEGIN
    ...
    SELECT EXECUTION_ID, INVENTORY_CONTENT
    FROM IDENTIFIER(:TABLE_NAME)
    WHERE FILE_NAME = :ISSUES_INVENTORY_NAME
    ), TABLE(FLATTEN(INVENTORY_CONTENT)) INVENTORY_CONTENT_JSON
    );
...
COMMENT ON PROCEDURE "SNOW_DB"."SNOW_SCHEMA"."MERGE_ISSUES_INVENTORY"(VARCHAR) IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":1,"patch":112}} ';
...
BEGIN
   ...
   INSERT INTO JOINS_INVENTORY(
    ...
    SELECT EXECUTION_ID, INVENTORY_CONTENT
    FROM IDENTIFIER(:TABLE_NAME)
    WHERE FILE_NAME = :JOINS_INVENTORY_NAME
    ), TABLE(FLATTEN(INVENTORY_CONTENT)) INVENTORY_CONTENT_JSON
    );
...
COMMENT ON PROCEDURE "SNOW_DB"."SNOW_SCHEMA"."MERGE_JOINS_INVENTORY"(VARCHAR) IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":1,"patch":112}} ';
...
BEGIN
    ...
    SELECT EXECUTION_ID, INVENTORY_CONTENT
    FROM IDENTIFIER(:TABLE_NAME)
    WHERE FILE_NAME = :NOTEBOOK_CELLS_INVENTORY_NAME
    ), TABLE(FLATTEN(INVENTORY_CONTENT)) INVENTORY_CONTENT_JSON
    );
...
COMMENT ON PROCEDURE "SNOW_DB"."SNOW_SCHEMA"."MERGE_NOTEBOOK_CELLS_INVENTORY"(VARCHAR) IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":1,"patch":112}} ';
...
BEGIN
    ...
    SELECT EXECUTION_ID, INVENTORY_CONTENT
    FROM IDENTIFIER(:TABLE_NAME)
    WHERE FILE_NAME = :NOTEBOOK_SIZE_INVENTORY_NAME
    ), TABLE(FLATTEN(INVENTORY_CONTENT)) INVENTORY_CONTENT_JSON
    );
...
COMMENT ON PROCEDURE "SNOW_DB"."SNOW_SCHEMA"."MERGE_NOTEBOOK_SIZE_INVENTORY"(VARCHAR) IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":1,"patch":112}} ';
...
BEGIN
    ...
    SELECT EXECUTION_ID, INVENTORY_CONTENT
    FROM IDENTIFIER(:TABLE_NAME)
    WHERE FILE_NAME = :PACKAGES_INVENTORY_NAME
    ), TABLE(FLATTEN(INVENTORY_CONTENT)) INVENTORY_CONTENT_JSON
    );
...
COMMENT ON PROCEDURE "SNOW_DB"."SNOW_SCHEMA"."MERGE_PACKAGE_INVENTORY"(VARCHAR) IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":1,"patch":112}} -PO1vG5dh';
...
BEGIN
    ...
    SELECT EXECUTION_ID, INVENTORY_CONTENT
    FROM IDENTIFIER(:TABLE_NAME)
    WHERE FILE_NAME = :PACKAGE_VERSIONS_NAME
    ), TABLE(FLATTEN(INVENTORY_CONTENT)) INVENTORY_CONTENT_JSON
    );
...
COMMENT ON PROCEDURE "SNOW_DB"."SNOW_SCHEMA"."MERGE_PACKAGE_VERSIONS_INVENTORY"(VARCHAR) IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":1,"patch":112}} ';
...
BEGIN
    ...
    SELECT EXECUTION_ID, INVENTORY_CONTENT
    FROM IDENTIFIER(:TABLE_NAME)
    WHERE FILE_NAME = :PANDAS_USAGES_INVENTORY_NAME
    ), TABLE(FLATTEN(INVENTORY_CONTENT)) INVENTORY_CONTENT_JSON
    );
...
COMMENT ON PROCEDURE "SNOW_DB"."SNOW_SCHEMA"."MERGE_PANDAS_USAGES_INVENTORY"(VARCHAR) IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":1,"patch":112}} ';
...
BEGIN
    ...
    SELECT EXECUTION_ID, INVENTORY_CONTENT
    FROM IDENTIFIER(:TABLE_NAME)
    WHERE FILE_NAME = :SPARK_USAGES_INVENTORY_NAME
    ), TABLE(FLATTEN(INVENTORY_CONTENT)) INVENTORY_CONTENT_JSON
    );
...
COMMENT ON PROCEDURE "SNOW_DB"."SNOW_SCHEMA"."MERGE_SPARK_USAGES_INVENTORY"(VARCHAR) IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":1,"patch":112}} ';
...
BEGIN
    ...
    SELECT EXECUTION_ID, INVENTORY_CONTENT
    FROM IDENTIFIER(:TABLE_NAME)
    WHERE FILE_NAME = :SQL_ELEMENTS_INVENTORY_NAME
    ), TABLE(FLATTEN(INVENTORY_CONTENT)) INVENTORY_CONTENT_JSON
    );
...
COMMENT ON PROCEDURE "SNOW_DB"."SNOW_SCHEMA"."MERGE_SQL_ELEMENTS_INVENTORY"(VARCHAR) IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":1,"patch":112}} -ny__';
...
BEGIN
    ...
    SELECT EXECUTION_ID, INVENTORY_CONTENT
    FROM IDENTIFIER(:TABLE_NAME)
    WHERE FILE_NAME = :SQL_EMBEDDED_USAGES_INVENTORY_NAME
    ), TABLE(FLATTEN(INVENTORY_CONTENT)) INVENTORY_CONTENT_JSON
    );
...
COMMENT ON PROCEDURE "SNOW_DB"."SNOW_SCHEMA"."MERGE_SQL_EMBEDDED_USAGES_INVENTORY"(VARCHAR) IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":1,"patch":112}} ';
...
BEGIN
    ...
    SELECT EXECUTION_ID, INVENTORY_CONTENT
    FROM IDENTIFIER(:TABLE_NAME)
    WHERE FILE_NAME = :SQL_FUNCTIONS_INVENTORY_NAME
    ), TABLE(FLATTEN(INVENTORY_CONTENT)) INVENTORY_CONTENT_JSON
    );
...
COMMENT ON PROCEDURE "SNOW_DB"."SNOW_SCHEMA"."MERGE_SQL_FUNCTIONS_INVENTORY"(VARCHAR) IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":1,"patch":112}} -V_PqPg';
...
BEGIN
   ...
   INSERT INTO THIRD_PARTY_USAGES_INVENTORY(
    ...
    SELECT EXECUTION_ID, INVENTORY_CONTENT
    FROM IDENTIFIER(:TABLE_NAME)
    WHERE FILE_NAME = :THIRD_PARTY_USAGES_INVENTORY_NAME
    ), TABLE(FLATTEN(INVENTORY_CONTENT)) INVENTORY_CONTENT_JSON
    );
...
COMMENT ON PROCEDURE "SNOW_DB"."SNOW_SCHEMA"."MERGE_THIRD_PARTY_USAGES_INVENTORY"(VARCHAR) IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":1,"patch":112}} -IRHzk-ly';
...
COMMENT ON PROCEDURE "SNOW_DB"."SNOW_SCHEMA"."PRE_CALC_DEPENDENCY_ANALYSIS"() IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":1,"patch":112}} ';
...
COMMENT ON PROCEDURE "SNOW_DB"."SNOW_SCHEMA"."REFRESH_MANUAL_EXECUTION"() IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":1,"patch":112}} -UWt55BgZybWLGB';
...
COMMENT ON PROCEDURE "SNOW_DB"."SNOW_SCHEMA"."REFRESH_MANUAL_MAPPINGS"() IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":1,"patch":112}} -mp5BCeQ_p';
...
COMMENT ON PROCEDURE "SNOW_DB"."SNOW_SCHEMA"."REFRESH_MAPPINGS_CORE"() IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":1,"patch":112}} -';
...
CREATE OR REPLACE TASK "SNOW_DB"."SNOW_SCHEMA"."PRE_CALC_DEPENDENCY_ANALYSIS"
WAREHOUSE = "SNOW_WAREHOUSE"
COMMENT = '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":1,"patch":112}}'
WHEN SYSTEM$STREAM_HAS_DATA('EXECUTION_INFO_STREAM')
AS
BEGIN
  CALL CALL PRE_CALC_DEPENDENCY_ANALYSIS();
EXCEPTION
    WHEN STATEMENT_ERROR THEN
      RETURN OBJECT_CONSTRUCT('Error type', 'STATEMENT_ERROR',
                          'SQLCODE', SQLCODE,
  ...
  RETURN 'PRE_CALC_DEPENDENCY_ANALYSIS FINISHED';
END;;

COMMENT ON TASK "SNOW_DB"."SNOW_SCHEMA"."PRE_CALC_DEPENDENCY_ANALYSIS" IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":1,"patch":112}} ';
...
COMMENT ON TASK "SNOW_DB"."SNOW_SCHEMA"."REFRESH_MAPPINGS_CORE_TASK" IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":1,"patch":112}} ';
...
COMMENT ON TASK "SNOW_DB"."SNOW_SCHEMA"."UPDATE_IAA_TABLES_TASK" IS '{"origin":"sf_sit","name":"iaa","version":{"major":0,"minor":1,"patch":112}} ';
